...
bool Types::InputFileLocation::operator ==(const InputFileLocation &b) {
...
void Types::InputFileLocation::setClassType(InputFileLocation::InputFileLocationType classType) {
    m_classType = classType;
}

Types::InputFileLocation::InputFileLocationType Types::InputFileLocation::classType() const {
    return m_classType;
}
