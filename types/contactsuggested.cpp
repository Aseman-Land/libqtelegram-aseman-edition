...
bool Types::ContactSuggested::operator ==(const ContactSuggested &b) {
    return m_mutualContacts == b.m_mutualContacts &&
           m_userId == b.m_userId;
}

void Types::ContactSuggested::setClassType(ContactSuggested::ContactSuggestedType classType) {
    m_classType = classType;
}

Types::ContactSuggested::ContactSuggestedType Types::ContactSuggested::classType() const {
    return m_classType;
}
