...
bool Types::UserStatus::operator ==(const UserStatus &b) {
    return m_expires == b.m_expires &&
           m_wasOnline == b.m_wasOnline;
}

void Types::UserStatus::setClassType(UserStatus::UserStatusType classType) {
    m_classType = classType;
}

Types::UserStatus::UserStatusType Types::UserStatus::classType() const {
    return m_classType;
}
