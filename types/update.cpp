...
bool Types::Update::operator ==(const Update &b) {
...
void Types::Update::setClassType(Update::UpdateType classType) {
    m_classType = classType;
}

Types::Update::UpdateType Types::Update::classType() const {
    return m_classType;
}
