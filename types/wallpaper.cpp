...
bool Types::WallPaper::operator ==(const WallPaper &b) {
...
void Types::WallPaper::setClassType(WallPaper::WallPaperType classType) {
    m_classType = classType;
}

Types::WallPaper::WallPaperType Types::WallPaper::classType() const {
    return m_classType;
}
