...
bool Functions::Upload::getFile(OutboundPkt *out, const Types::InputFileLocation &location, qint32 offset, qint32 limit) {
...
Types::UploadFile Functions::Upload::getFileResult(InboundPkt *in) {
    Types::UploadFile result;
