...
bool Types::InputChatPhoto::operator ==(const InputChatPhoto &b) {
    return m_crop == b.m_crop &&
           m_file == b.m_file &&
           m_id == b.m_id;
}

void Types::InputChatPhoto::setClassType(InputChatPhoto::InputChatPhotoType classType) {
    m_classType = classType;
}

Types::InputChatPhoto::InputChatPhotoType Types::InputChatPhoto::classType() const {
    return m_classType;
}
