...
bool Types::ChatParticipants::operator ==(const ChatParticipants &b) {
...
void Types::ChatParticipants::setClassType(ChatParticipants::ChatParticipantsType classType) {
    m_classType = classType;
}

Types::ChatParticipants::ChatParticipantsType Types::ChatParticipants::classType() const {
    return m_classType;
}
