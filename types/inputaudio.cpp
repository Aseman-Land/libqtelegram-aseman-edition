...
bool Types::InputAudio::operator ==(const InputAudio &b) {
    return m_accessHash == b.m_accessHash &&
           m_id == b.m_id;
}

void Types::InputAudio::setClassType(InputAudio::InputAudioType classType) {
    m_classType = classType;
}

Types::InputAudio::InputAudioType Types::InputAudio::classType() const {
    return m_classType;
}
