...
bool Types::AccountPasswordInputSettings::operator ==(const AccountPasswordInputSettings &b) {
...
void Types::AccountPasswordInputSettings::setClassType(AccountPasswordInputSettings::AccountPasswordInputSettingsType classType) {
    m_classType = classType;
}

Types::AccountPasswordInputSettings::AccountPasswordInputSettingsType Types::AccountPasswordInputSettings::classType() const {
    return m_classType;
}
