...
bool Types::MessageAction::operator ==(const MessageAction &b) {
...
void Types::MessageAction::setClassType(MessageAction::MessageActionType classType) {
    m_classType = classType;
}

Types::MessageAction::MessageActionType Types::MessageAction::classType() const {
    return m_classType;
}
