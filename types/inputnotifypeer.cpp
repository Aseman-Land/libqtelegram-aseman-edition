...
bool Types::InputNotifyPeer::operator ==(const InputNotifyPeer &b) {
    return m_peerInputGeoChat == b.m_peerInputGeoChat &&
           m_peerInput == b.m_peerInput;
}

void Types::InputNotifyPeer::setClassType(InputNotifyPeer::InputNotifyPeerType classType) {
    m_classType = classType;
}

Types::InputNotifyPeer::InputNotifyPeerType Types::InputNotifyPeer::classType() const {
    return m_classType;
}
