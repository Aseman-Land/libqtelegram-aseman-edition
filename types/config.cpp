...
Types::Config::Config(ConfigType classType, InboundPkt *in) :
...
Types::Config::Config(InboundPkt *in) :
    m_broadcastSizeMax(0),
    m_chatBigSize(0),
    m_chatSizeMax(0),
    m_date(0),
...
void Types::Config::setBroadcastSizeMax(qint32 broadcastSizeMax) {
    m_broadcastSizeMax = broadcastSizeMax;
}

qint32 Types::Config::broadcastSizeMax() const {
    return m_broadcastSizeMax;
}

void Types::Config::setChatBigSize(qint32 chatBigSize) {
    m_chatBigSize = chatBigSize;
}

qint32 Types::Config::chatBigSize() const {
    return m_chatBigSize;
}

void Types::Config::setChatSizeMax(qint32 chatSizeMax) {
    m_chatSizeMax = chatSizeMax;
}

qint32 Types::Config::chatSizeMax() const {
    return m_chatSizeMax;
}

void Types::Config::setDate(qint32 date) {
    m_date = date;
}

qint32 Types::Config::date() const {
    return m_date;
}

void Types::Config::setDcOptions(const QList<DcOption> &dcOptions) {
    m_dcOptions = dcOptions;
}

QList<DcOption> Types::Config::dcOptions() const {
    return m_dcOptions;
}

void Types::Config::setDisabledFeatures(const QList<DisabledFeature> &disabledFeatures) {
    m_disabledFeatures = disabledFeatures;
}

QList<DisabledFeature> Types::Config::disabledFeatures() const {
    return m_disabledFeatures;
}

void Types::Config::setExpires(qint32 expires) {
    m_expires = expires;
}

qint32 Types::Config::expires() const {
    return m_expires;
}

void Types::Config::setForwardedCountMax(qint32 forwardedCountMax) {
    m_forwardedCountMax = forwardedCountMax;
}

qint32 Types::Config::forwardedCountMax() const {
    return m_forwardedCountMax;
}

void Types::Config::setNotifyCloudDelayMs(qint32 notifyCloudDelayMs) {
    m_notifyCloudDelayMs = notifyCloudDelayMs;
}

qint32 Types::Config::notifyCloudDelayMs() const {
    return m_notifyCloudDelayMs;
}

void Types::Config::setNotifyDefaultDelayMs(qint32 notifyDefaultDelayMs) {
    m_notifyDefaultDelayMs = notifyDefaultDelayMs;
}

qint32 Types::Config::notifyDefaultDelayMs() const {
    return m_notifyDefaultDelayMs;
}

void Types::Config::setOfflineBlurTimeoutMs(qint32 offlineBlurTimeoutMs) {
    m_offlineBlurTimeoutMs = offlineBlurTimeoutMs;
}

qint32 Types::Config::offlineBlurTimeoutMs() const {
    return m_offlineBlurTimeoutMs;
}

void Types::Config::setOfflineIdleTimeoutMs(qint32 offlineIdleTimeoutMs) {
    m_offlineIdleTimeoutMs = offlineIdleTimeoutMs;
}

qint32 Types::Config::offlineIdleTimeoutMs() const {
    return m_offlineIdleTimeoutMs;
}

void Types::Config::setOnlineCloudTimeoutMs(qint32 onlineCloudTimeoutMs) {
    m_onlineCloudTimeoutMs = onlineCloudTimeoutMs;
}

qint32 Types::Config::onlineCloudTimeoutMs() const {
    return m_onlineCloudTimeoutMs;
}

void Types::Config::setOnlineUpdatePeriodMs(qint32 onlineUpdatePeriodMs) {
    m_onlineUpdatePeriodMs = onlineUpdatePeriodMs;
}

qint32 Types::Config::onlineUpdatePeriodMs() const {
    return m_onlineUpdatePeriodMs;
}

void Types::Config::setPushChatLimit(qint32 pushChatLimit) {
    m_pushChatLimit = pushChatLimit;
}

qint32 Types::Config::pushChatLimit() const {
    return m_pushChatLimit;
}

void Types::Config::setPushChatPeriodMs(qint32 pushChatPeriodMs) {
    m_pushChatPeriodMs = pushChatPeriodMs;
}

qint32 Types::Config::pushChatPeriodMs() const {
    return m_pushChatPeriodMs;
}

void Types::Config::setTestMode(bool testMode) {
    m_testMode = testMode;
}

bool Types::Config::testMode() const {
    return m_testMode;
}

void Types::Config::setThisDc(qint32 thisDc) {
    m_thisDc = thisDc;
}

qint32 Types::Config::thisDc() const {
    return m_thisDc;
}

bool Types::Config::operator ==(const Config &b) {
...
void Types::Config::setClassType(Config::ConfigType classType) {
    m_classType = classType;
}

Types::Config::ConfigType Types::Config::classType() const {
    return m_classType;
}

bool Types::Config::fetch(InboundPkt *in) {
    LQTG_FETCH_LOG;
    int x = in->fetchInt();
    switch(x) {
    case typeConfig: {
...
bool Types::Config::push(OutboundPkt *out) const {
