...
Types::UpdatesType Functions::Messages::sendMediaResult(InboundPkt *in) {
    Types::UpdatesType result;
    if(!result.fetch(in)) return result;
    return result;
}
...
Types::UpdatesType Functions::Messages::forwardMessagesResult(InboundPkt *in) {
    Types::UpdatesType result;
    if(!result.fetch(in)) return result;
    return result;
}
...
Types::UpdatesType Functions::Messages::editChatTitleResult(InboundPkt *in) {
    Types::UpdatesType result;
    if(!result.fetch(in)) return result;
    return result;
}
...
Types::UpdatesType Functions::Messages::editChatPhotoResult(InboundPkt *in) {
    Types::UpdatesType result;
    if(!result.fetch(in)) return result;
    return result;
}
...
Types::UpdatesType Functions::Messages::addChatUserResult(InboundPkt *in) {
    Types::UpdatesType result;
    if(!result.fetch(in)) return result;
    return result;
}
...
Types::UpdatesType Functions::Messages::deleteChatUserResult(InboundPkt *in) {
    Types::UpdatesType result;
    if(!result.fetch(in)) return result;
    return result;
}
...
Types::UpdatesType Functions::Messages::createChatResult(InboundPkt *in) {
    Types::UpdatesType result;
    if(!result.fetch(in)) return result;
    return result;
}
...
Types::UpdatesType Functions::Messages::forwardMessageResult(InboundPkt *in) {
    Types::UpdatesType result;
    if(!result.fetch(in)) return result;
    return result;
}
...
Types::UpdatesType Functions::Messages::sendBroadcastResult(InboundPkt *in) {
    Types::UpdatesType result;
    if(!result.fetch(in)) return result;
    return result;
}
...
Types::UpdatesType Functions::Messages::importChatInviteResult(InboundPkt *in) {
    Types::UpdatesType result;
    if(!result.fetch(in)) return result;
    return result;
}
