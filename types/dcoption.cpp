...
bool Types::DcOption::operator ==(const DcOption &b) {
...
void Types::DcOption::setClassType(DcOption::DcOptionType classType) {
    m_classType = classType;
}

Types::DcOption::DcOptionType Types::DcOption::classType() const {
    return m_classType;
}
