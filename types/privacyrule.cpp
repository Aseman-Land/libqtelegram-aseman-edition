...
bool Types::PrivacyRule::operator ==(const PrivacyRule &b) {
    return m_users == b.m_users;
}

void Types::PrivacyRule::setClassType(PrivacyRule::PrivacyRuleType classType) {
    m_classType = classType;
}

Types::PrivacyRule::PrivacyRuleType Types::PrivacyRule::classType() const {
    return m_classType;
}
