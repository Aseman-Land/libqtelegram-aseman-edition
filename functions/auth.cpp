...
Types::AuthCheckedPhone Functions::Auth::checkPhoneResult(InboundPkt *in) {
    Types::AuthCheckedPhone result;
...
Types::AuthSentCode Functions::Auth::sendCodeResult(InboundPkt *in) {
    Types::AuthSentCode result;
    if(!result.fetch(in)) return result;
    return result;
}
...
Types::AuthAuthorization Functions::Auth::signUpResult(InboundPkt *in) {
    Types::AuthAuthorization result;
    if(!result.fetch(in)) return result;
    return result;
}
...
Types::AuthAuthorization Functions::Auth::signInResult(InboundPkt *in) {
    Types::AuthAuthorization result;
    if(!result.fetch(in)) return result;
    return result;
}
...
Types::AuthExportedAuthorization Functions::Auth::exportAuthorizationResult(InboundPkt *in) {
    Types::AuthExportedAuthorization result;
    if(!result.fetch(in)) return result;
    return result;
}
...
Types::AuthAuthorization Functions::Auth::importAuthorizationResult(InboundPkt *in) {
    Types::AuthAuthorization result;
    if(!result.fetch(in)) return result;
    return result;
}
...
Types::AuthAuthorization Functions::Auth::checkPasswordResult(InboundPkt *in) {
    Types::AuthAuthorization result;
    if(!result.fetch(in)) return result;
    return result;
}
...
Types::AuthPasswordRecovery Functions::Auth::requestPasswordRecoveryResult(InboundPkt *in) {
    Types::AuthPasswordRecovery result;
    if(!result.fetch(in)) return result;
    return result;
}
...
Types::AuthAuthorization Functions::Auth::recoverPasswordResult(InboundPkt *in) {
    Types::AuthAuthorization result;
    if(!result.fetch(in)) return result;
    return result;
}
