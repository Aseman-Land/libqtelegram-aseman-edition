...
bool Types::UserFull::operator ==(const UserFull &b) {
...
void Types::UserFull::setClassType(UserFull::UserFullType classType) {
    m_classType = classType;
}

Types::UserFull::UserFullType Types::UserFull::classType() const {
    return m_classType;
}
